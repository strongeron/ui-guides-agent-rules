    ...
    <div className="w-full max-w-sm space-y-4">
      <div className="bg-card border border-border rounded-lg p-4">
        ...
        <div className="space-y-3">
          {/* BAD: outline-none with NO replacement focus indicator */}
          {/* Keyboard users cannot see what's focused */}
          <div className="flex gap-2 p-3 bg-muted rounded-lg">
            <button
              className="px-4 py-2 bg-primary text-primary-foreground rounded-md outline-none focus:outline-none"
              style={{ outline: 'none' }}
            ...
            <button
              className="px-4 py-2 border border-border rounded-md outline-none focus:outline-none"
              style={{ outline: 'none' }}
              // BAD: No focus-visible:ring-* replacement!
            >
              Button 2
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-border rounded-md outline-none focus:outline-none"
            style={{ outline: 'none' }}
