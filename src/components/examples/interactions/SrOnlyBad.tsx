  ...
  return (
    <div className="w-full max-w-sm space-y-4">
      <div className="bg-card border border-border rounded-lg p-4">
        <h4 className="font-medium mb-3">Inaccessible Icon Buttons</h4>
        ...
        <div className="mt-4 bg-muted rounded p-3 font-mono text-xs">
          <code className="text-error">{`<button><svg>...</svg></button>`}</code>
          <p className="text-error mt-1">No accessible name!</p>
        </div>
      </div>
