      ...
      <div className="bg-card border border-border rounded-lg p-4 space-y-4">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-lg border border-foreground/8 bg-card text-sm text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
