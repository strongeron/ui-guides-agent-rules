...
export const animationsPrinciples: Principle[] = [
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — spec catalog', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text — soft-blur-in spec', url: 'https://github.com/pixel-point/animate-text/blob/main/catalog/text-animations/catalog.json' },
      { text: 'MDN — animation-delay', url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/animation-delay' },
    ],
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — swap scenario spec', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text', url: 'https://github.com/pixel-point/animate-text' },
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — soft-blur-in usage notes', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text', url: 'https://github.com/pixel-point/animate-text' },
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — typewriter spec', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text', url: 'https://github.com/pixel-point/animate-text' },
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — per-character-rise spec', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text', url: 'https://github.com/pixel-point/animate-text' },
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — swap modes', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text', url: 'https://github.com/pixel-point/animate-text' },
  ...
  },
  {
    ...
    sourceLinks: [
      { text: 'animate-text — rendering contract', url: 'https://pixelpoint.io/skills/animate-text/' },
      { text: 'pixel-point/animate-text', url: 'https://github.com/pixel-point/animate-text' },
